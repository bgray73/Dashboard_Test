...
All routes are mounted beneath `/api`. Phase 17 records exposure and mutation risk before authentication is introduced. **Except for collector routes, every route is currently unauthenticated and must remain limited to a trusted network.**
